...
import 'package:flutter_git_repo_demo/states/freezed/waiting_issues_state.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

final waitingIssuesProvider =
StateNotifierProvider<WaitingIssuesNotifier, WaitingIssuesState>((ref) {
...
class WaitingIssuesNotifier extends StateNotifier<WaitingIssuesState> {
  ...
  void _initList(
    ...
    final labels = 'waiting for customer response';
