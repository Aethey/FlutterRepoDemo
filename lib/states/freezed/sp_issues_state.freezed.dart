...
/// @nodoc
class _$SpIssuesStateTearOff {
  const _$SpIssuesStateTearOff();
...
/// @nodoc
const $SpIssuesState = _$SpIssuesStateTearOff();

/// @nodoc
mixin _$SpIssuesState {
  ...
  @JsonKey(ignore: true)
  $SpIssuesStateCopyWith<SpIssuesState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SpIssuesStateCopyWith<$Res> {
  factory $SpIssuesStateCopyWith(
          SpIssuesState value, $Res Function(SpIssuesState) then) =
      _$SpIssuesStateCopyWithImpl<$Res>;
  $Res call(
      {int page,
      int per_page,
      String sort,
...
/// @nodoc
class _$SpIssuesStateCopyWithImpl<$Res>
    implements $SpIssuesStateCopyWith<$Res> {
  _$SpIssuesStateCopyWithImpl(this._value, this._then);

  final SpIssuesState _value;
  // ignore: unused_field
  final $Res Function(SpIssuesState) _then;
...
/// @nodoc
abstract class _$SpIssuesStateCopyWith<$Res>
    implements $SpIssuesStateCopyWith<$Res> {
  factory _$SpIssuesStateCopyWith(
          _SpIssuesState value, $Res Function(_SpIssuesState) then) =
      __$SpIssuesStateCopyWithImpl<$Res>;
  @override
  $Res call(
      {int page,
      int per_page,
...
/// @nodoc
class __$SpIssuesStateCopyWithImpl<$Res>
    extends _$SpIssuesStateCopyWithImpl<$Res>
    implements _$SpIssuesStateCopyWith<$Res> {
  __$SpIssuesStateCopyWithImpl(
      _SpIssuesState _value, $Res Function(_SpIssuesState) _then)
      : super(_value, (v) => _then(v as _SpIssuesState));

  @override
  _SpIssuesState get _value => super._value as _SpIssuesState;
...
class _$_SpIssuesState extends _SpIssuesState {
  const _$_SpIssuesState(
      {this.page = 1,
      this.per_page = 30,
      this.sort = 'created',
      this.direction = 'desc',
  ...
  @override
  String toString() {
    return 'SpIssuesState(page: $page, per_page: $per_page, sort: $sort, direction: $direction, since: $since, state: $state, labels: $labels, isLoading: $isLoading, isLoadMoreError: $isLoadMoreError, isLoadMoreDone: $isLoadMoreDone, issues: $issues)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SpIssuesState &&
  ...
  @JsonKey(ignore: true)
  @override
  _$SpIssuesStateCopyWith<_SpIssuesState> get copyWith =>
      __$SpIssuesStateCopyWithImpl<_SpIssuesState>(this, _$identity);
}

abstract class _SpIssuesState extends SpIssuesState {
  const factory _SpIssuesState(
      {int page,
      int per_page,
      String sort,
      String direction,
      ...
      bool isLoadMoreError,
      bool isLoadMoreDone,
      List<IssueEntity>? issues}) = _$_SpIssuesState;
  const _SpIssuesState._() : super._();
