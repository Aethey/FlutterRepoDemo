...
class _$_AllIssuesState extends _AllIssuesState {
  ...
  @override
  String toString() {
    return 'AllIssuesState(page: $page, per_page: $per_page, sort: $sort, direction: $direction, since: $since, isLoading: $isLoading, isLoadMoreError: $isLoadMoreError, isLoadMoreDone: $isLoadMoreDone, issues: $issues)';
  }
