...
part of 'share_issues_state.dart';
...
/// @nodoc
class _$ShareIssuesStateTearOff {
  const _$ShareIssuesStateTearOff();

  _ShareIssuesState call(
      {int page = 1,
      int per_page = 30,
      String sort = 'created',
...
/// @nodoc
const $ShareIssuesState = _$ShareIssuesStateTearOff();

/// @nodoc
mixin _$ShareIssuesState {
  ...
  @JsonKey(ignore: true)
  $ShareIssuesStateCopyWith<ShareIssuesState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ShareIssuesStateCopyWith<$Res> {
  factory $ShareIssuesStateCopyWith(
          ShareIssuesState value, $Res Function(ShareIssuesState) then) =
      _$ShareIssuesStateCopyWithImpl<$Res>;
  $Res call(
      {int page,
      int per_page,
      String sort,
...
/// @nodoc
class _$ShareIssuesStateCopyWithImpl<$Res>
    implements $ShareIssuesStateCopyWith<$Res> {
  _$ShareIssuesStateCopyWithImpl(this._value, this._then);

  final ShareIssuesState _value;
  // ignore: unused_field
  final $Res Function(ShareIssuesState) _then;
...
/// @nodoc
abstract class _$ShareIssuesStateCopyWith<$Res>
    implements $ShareIssuesStateCopyWith<$Res> {
  factory _$ShareIssuesStateCopyWith(
          _ShareIssuesState value, $Res Function(_ShareIssuesState) then) =
      __$ShareIssuesStateCopyWithImpl<$Res>;
  @override
  $Res call(
      {int page,
      int per_page,
...
/// @nodoc
class __$ShareIssuesStateCopyWithImpl<$Res>
    extends _$ShareIssuesStateCopyWithImpl<$Res>
    implements _$ShareIssuesStateCopyWith<$Res> {
  __$ShareIssuesStateCopyWithImpl(
      _ShareIssuesState _value, $Res Function(_ShareIssuesState) _then)
      : super(_value, (v) => _then(v as _ShareIssuesState));

  @override
  _ShareIssuesState get _value => super._value as _ShareIssuesState;
  ...
  $Res call({
    ...
    return _then(_ShareIssuesState(
      page: page == freezed
          ? _value.page
          : page // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_ShareIssuesState extends _ShareIssuesState {
  const _$_ShareIssuesState(
      {this.page = 1,
      this.per_page = 30,
      this.sort = 'created',
      this.direction = 'desc',
  ...
  @JsonKey(ignore: true)
  @override
  _$ShareIssuesStateCopyWith<_ShareIssuesState> get copyWith =>
      __$ShareIssuesStateCopyWithImpl<_ShareIssuesState>(this, _$identity);
}

abstract class _ShareIssuesState extends ShareIssuesState {
  const factory _ShareIssuesState(
      {int page,
      int per_page,
      String sort,
      String direction,
      ...
      bool isLoadMoreError,
      bool isLoadMoreDone,
      List<IssueEntity>? issues}) = _$_ShareIssuesState;
  const _ShareIssuesState._() : super._();
